...
export default function LoginForm() {
  ...
  const { signIn, closeAuthModal, openAuthModal } = useAuth();
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-ink-900 mb-2">Welcome back</h2>
      <p className="text-ink-600 mb-6">Log in to continue your learning</p>
